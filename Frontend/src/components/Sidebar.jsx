...
import Title from '../images/logo/title1.png'
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className='flex items-center justify-between  px-8 py-2.5 lg:py-0.1'>
        {/* <NavLink to='/'> */}
                ...
                if (role == "Admin") {
                  return <>
                    ...
                    <li>
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('manageTransaction') && 'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <CurrencyRupeeIcon />Transaction
                      </NavLink>
                    </li>
                    <li>
                      <NavLink
                    ...
                    {/* <li>
                      <NavLink
                        to='/manageUser'
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('manageUser') && 'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <HowToRegIcon />
                        User Master
                    ...
                    {/* <li>
                      <NavLink
                        to='/department'
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('department') && 'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <GroupWorkIcon />
                        Department
                    ...
                    <li>
                      <NavLink
                        to='/organization'
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('organization') && 'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <ApartmentIcon />
                        Organization
                    ...
                    <li>
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('employee-management') &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <BadgeIcon />
                    ...
                    <li>
                      <NavLink
                        to='/gst'
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('gst') &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <ArticleIcon />
                    ...
                    <li>
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('manage-attendence') &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <BadgeIcon />
                    ...
                    <li>
                      <NavLink
                        to='/manage-leave'
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('manage-leave') &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <EmailIcon />
                    ...
                    <li>
                      <NavLink
                        to='/manage-project'
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('manage-project') &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <AccountTreeIcon />
                    ...
                    <li>
                      <NavLink
                        to='/manage-milestone'
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('manage-milestone') &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <DiscountIcon />
                    ...
                    <li>
                      <NavLink
                        to='/manage-task'
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('manage-task') &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <AssignmentIcon />
                    ...
                    <li>
                      <NavLink
                        to='/manage-issue'
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('manage-issue') &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <BugReportIcon />
                    ...
                    <li>
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('manage-dependency') &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <AssignmentIcon />
                  ...
                  return <>
                    ...
                    <li>
                      <NavLink
                        to='/emp-salary-slip'
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('emp-salary-slip') &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <CurrencyRupeeIcon />
