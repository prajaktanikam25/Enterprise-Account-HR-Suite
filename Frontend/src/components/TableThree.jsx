    ...
    <>
      <div className='rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1'>
        <div className='max-w-full overflow-x-auto'>
          <table className='w-full table-auto' style={{minHeight:'200px'}}>
            <thead>
              <tr className='bg-gray-2 text-left dark:bg-meta-4'>
                {
                  data ? Object.keys(data[0]).map((item, index) => {
                    return (<th key={index} className='min-w-[220px] py-4 px-4 font-medium text-black dark:text-white xl:pl-11'>
                      {item}
                    </th>)
                  }) : null
                }
            ...
            <tbody>
              {/* <tr> */}
              {
                data ? data.map((item, index) => {
                  return (
                    <tr key={index}>{
                      Object.keys(item).map((list, index) => {
                        return (
