...
const EditCommission = ({ handleClose, theEditData }) => {
    const [type, setType] = useState(theEditData.type)
    ...
    const postData = () => {
        ...
        axios.put(BASE_URL + '/updateCommission/' + theEditData._id, commission)
        handleClose()
    }
    const changePage = () => {
        handleClose()
