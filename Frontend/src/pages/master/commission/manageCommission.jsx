...
const ManageCommission = () => {
    ...
    const getIncomeData = async () => {
        await axios.get(BASE_URL + `/getCommission`)
            .then((response) => {
    ...
    return (
        <div className='flex flex-col gap-10'>
            ...
            <Dialog open={open1} fullWidth>
                ...
                <DialogContent>
                    <AddCommission handleClose={handleClose1} ></AddCommission>
                </DialogContent>
            ...
            <Dialog open={show} fullWidth>
                ...
                <DialogContent>
                    <EditCommission handleClose={CloseEdit} theEditData={obj1}></EditCommission>
                </DialogContent>
            </Dialog>
        </div>
