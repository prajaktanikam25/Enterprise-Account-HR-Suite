...
import AddCatalogue from './addCategory';
import EditCatalogue from './editCategory';
    ...
    return (
        ...
        <div className='flex flex-col gap-10'>
            ...
            <Dialog open={open1} fullWidth>
                <DialogTitle>Add Monthly Budget
                    <IconButton
                        aria-label="close"
                ...
                <DialogContent>
                    ...
                    <AddCatalogue handleClose={handleClose1}></AddCatalogue>
                </DialogContent>
            ...
            <Dialog open={show} fullWidth>
                ...
                <DialogContent>
                    ...
                    <EditCatalogue handleClose={CloseEdit} theEditData={obj1}></EditCatalogue>
                </DialogContent>
            </Dialog>
        </div>
