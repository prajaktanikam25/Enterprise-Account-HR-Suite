...
import AddOrganzation from './addOrganization';
...
const ManageOrganzation = () => {
    ...
    const getOrganizationData = async () => {
        await axios.get(BASE_URL + `/getOrganization`)
            .then((response) => {
        ...
        <>
            <div className='flex flex-col gap-10'>
                    ...
                    <Table sx={{ minWidth: 650 }} aria-label="simple table">
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell align="center">Branch Manager</TableCell>
                ...
                <Dialog open={open1} fullWidth>
                    ...
                    <DialogContent>
                        <AddOrganzation handleClose={handleClose1}></AddOrganzation>
                    </DialogContent>
                ...
                <Dialog open={show} fullWidth>
                    ...
                    <DialogContent>
                        <EditOrganization theEditData={obj1} handleClose={CloseEdit}></EditOrganization>
                    </DialogContent>
